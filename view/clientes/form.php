...
<h3><?= isset($cliente) && $cliente->getIdCliente() > 0 ? 'Alterar' : 'Inserir' ?> Cliente</h3>
<form method="POST" action="<?= isset($cliente) && $cliente->getIdCliente() > 0 ? 'alterar.php' : 'inserir.php' ?>">

    <input type="hidden" name="id_cliente" value="<?= isset($cliente) ? ($cliente->getIdCliente() ?: '') : '' ?>" >

    <label for="nome">Nome:</label><br>
    <input type="text" id="nome" name="nome" maxlength="100" value="<?= isset($cliente) ? ($cliente->getNome() ?: '') : '' ?>" ><br><br>

    <label for="cpf">CPF:</label><br>
    <input type="text" id="cpf" name="cpf" maxlength="11" value="<?= isset($cliente) ? ($cliente->getCpf() ?: '') : '' ?>" ><br><br>

    <label for="telefone">Telefone:</label><br>
    <input type="text" id="telefone" name="telefone" maxlength="15" value="<?= isset($cliente) ? ($cliente->getTelefone() ?: '') : '' ?>" ><br><br>

    <label for="endereco">Endereço:</label><br>
    <input type="text" id="endereco" name="endereco" maxlength="200" value="<?= isset($cliente) ? ($cliente->getEndereco() ?: '') : '' ?>" ><br><br>
    ...
    <input type="date" id="data_cadastro" name="data_cadastro" value="<?= isset($cliente) ? ($cliente->getDataCadastro() ?: '') : '' ?>" ><br><br>
    ...
    <br><br><button type="submit"><?= isset($cliente) && $cliente->getIdCliente() > 0 ? 'Alterar' : 'Inserir' ?> </button> <button><a href="listar.php">Voltar</a></button>
